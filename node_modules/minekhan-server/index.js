...
class World{
  ...
  getSaveString(){
    ...
    let rnd = Math.round
    let options = p.flying | (this.superflat==="island" ? 2 : this.superflat) << 1 | p.spectator << 3 | this.caves << 4 | this.trees << 5 | this.survival << 6
...
function init(serverPort, name,description, options){
  ...
  function updatePlayers(){
    sendAllPlayers({type:"settings",time:375,data:{
      tntExplode:true,
      killCmdOff:false,
      dayNightCycle: false,
      blocksFall: true,
